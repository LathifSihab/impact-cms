...
const toPage = (p: Row, sections: Row[] = []): PageRecord => ({
  ...
  heroAnchorNav: Array.isArray(p.hero_anchor_nav) ? p.hero_anchor_nav : [],
  heroOverlayMeta: Array.isArray(p.hero_overlay_meta) ? p.hero_overlay_meta : [],
  heroVideoWebm: p.hero_video_webm ?? '',
  heroVideoMp4: p.hero_video_mp4 ?? '',
  heroVariant: p.hero_variant ?? 'page',
  heroTrust: Array.isArray(p.hero_trust) ? p.hero_trust : [],
  heroCtaLabel: p.hero_cta_label ?? '',
  heroCtaHref: p.hero_cta_href ?? '',
  heroCta2Label: p.hero_cta2_label ?? '',
  heroCta2Href: p.hero_cta2_href ?? '',
  ...
  const { error } = await db.from('pages').upsert(
    {
      ...
      hero_anchor_nav: input.heroAnchorNav,
      hero_overlay_meta: input.heroOverlayMeta,
      hero_video_webm: input.heroVideoWebm || null,
      hero_video_mp4: input.heroVideoMp4 || null,
      hero_variant: input.heroVariant,
      hero_trust: input.heroTrust,
      hero_cta_label: input.heroCtaLabel,
      hero_cta_href: input.heroCtaHref,
      hero_cta2_label: input.heroCta2Label,
      hero_cta2_href: input.heroCta2Href,
      seo: input.seo,
